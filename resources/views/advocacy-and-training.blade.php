...
@section('title', 'Advocacy & Training - Age Care Foundation')
...
<div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8 service-page-content">
    <div class="flex flex-wrap lg:flex-nowrap items-center -mx-4">
        <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
            <h1 class="text-5xl font-extrabold text-blue-900 mb-4">Advocacy & Training</h1>
            <p class="text-xl text-gray-600 mb-6">We are committed to advocating for the rights and well-being of seniors. Our advocacy efforts focus on raising awareness about the issues facing older adults and promoting policies that support their needs. We also offer training programs for caregivers and healthcare professionals.</p>
        </div>
