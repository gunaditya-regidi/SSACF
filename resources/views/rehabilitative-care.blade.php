...
<div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8 service-page-content">
    <div class="flex flex-wrap lg:flex-nowrap items-center -mx-4">
        <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
            ...
            <p class="text-xl text-gray-600 mb-6">Rehabilitative care helps seniors regain their strength, mobility, and independence after an illness, injury, or surgery. Our team of therapists works with each patient to create a personalized rehabilitation plan.</p>
        </div>
