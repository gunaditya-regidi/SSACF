...
<div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8 service-page-content">
    <div class="flex flex-wrap lg:flex-nowrap items-center -mx-4">
        <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
            <h1 class="text-5xl font-extrabold text-gray-900 mb-4">Outreach Geriatric Care</h1>
            <p class="text-xl text-gray-600 mb-6">Our Outreach Geriatric Care program brings our services to seniors in the community who may have difficulty accessing care. We provide in-home assessments, care management, and support to help seniors live safely and independently.</p>
        </div>
