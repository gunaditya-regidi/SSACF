...
<div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8 service-page-content">
    <div class="flex flex-wrap lg:flex-nowrap items-center -mx-4">
        <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
            <h1 class="text-5xl font-extrabold text-gray-900 mb-4">Geriatric Care</h1>
            <p class="text-xl text-gray-600 mb-6">Geriatric care is a specialty that focuses on the health care of elderly people. It aims to promote health by preventing and treating diseases and disabilities in older adults. We provide a holistic approach to meet the unique needs of our senior patients.</p>
        </div>
