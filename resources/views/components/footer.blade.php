    ...
    <div class="max-w-[1400px] mx-auto px-8 py-14">
        ...
        <div class="bg-[#2c3238] rounded-2xl px-8 py-6 mb-16">
            <div class="grid grid-cols-1 lg:grid-cols-[1fr_auto_1.5fr_auto] items-center gap-6 text-center lg:text-left">
                ...
                <!-- Center Button -->
                <div>
                    <a href="#" class="bg-white text-[#1a1d21] font-semibold py-3 px-7 rounded-full inline-flex items-center gap-2.5 hover:bg-[#25D366] hover:text-white transition-colors whitespace-nowrap text-[15px]">
