            ...
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                ...
                <div>
                    <div id="holistic-carousel" class="relative w-full h-96 rounded-lg shadow-lg overflow-hidden">
                        <div class="carousel-item active"><img src="{{ url('images/approach/3.jpeg') }}" alt="Holistic Care 1" class="absolute inset-0 w-full h-full object-contain"></div>
                  </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                ...
                <div>
                     <div id="family-carousel" class="relative w-full h-96 rounded-lg shadow-lg overflow-hidden">
                        <div class="carousel-item active"><img src="{{ url('images/approach/2.jpeg') }}" alt="Family Care 1" class="absolute inset-0 w-full h-full object-contain"></div>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="approach-card">
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                <div class="bg-white bg-opacity-75 p-6 rounded-lg">
                    ...
                    <p class="text-black leading-relaxed" style="text-align: justify;">Every life lived is measured not just in years but in the cherished moments gathered. We help our patients and their families to relive these moments and celebrate them even through their last days. Our dedicated volunteers recognize the unfulfilled wishes of our patients and help them realize them, may it be, spending a day playing their favourite board game or an evening walk in the lawns, to cooking their favourite dishes, or engaging them in singing or dancing. We try to add ‘Life to their days.’</p>
                </div>
                <div>
                     <div id="celebrating-carousel" class="relative w-full h-96 rounded-lg shadow-lg overflow-hidden">
                        <div class="carousel-item active"><img src="{{ url('images/approach/1.jpeg') }}" alt="Celebrating Life 1" class="absolute inset-0 w-full h-full object-contain"></div>
                  </div>
                </div>
            </div>
        </div>
