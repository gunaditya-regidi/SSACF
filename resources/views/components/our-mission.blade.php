<section class="py-20">
    <div class="container mx-auto px-4 max-w-10xl">
        ...
        <div class="w-full md:w-5/6 m-auto">
            ...
            <div class="flex flex-col md:flex-row items-center gap-8">
                ...
                <div class="w-full md:w-1/2">
                    <img src="{{ asset('images/art/mis.jpeg') }}" alt="A group of seniors happily engaging in a community activity." class="rounded-lg shadow-lg w-5/6 mx-auto">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-10 max-w-7xl">
        <div class="approach-card w-full">
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="w-full md:w-1/2">
                    <img src="{{ asset('images/art/vis.jpeg') }}" alt="A vibrant image representing the organization's future vision." class="rounded-lg shadow-lg w-5/6 mx-auto">
                </div>
                <div class="w-full md:w-1/2">
                    <h2 class="text-2xl font-bold text-blue-800 mb-4">Our Vision</h2>
