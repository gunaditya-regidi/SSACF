...
class PalliativeCareController extends Controller
{
    ...
    {
        $sliderImages = [
            ['url' => Storage::url('images/services/pc1.jpeg'), 'title' => 'Comfort in Care', 'description' => 'Our team provides compassionate support to ensure comfort at every stage.'],
            ['url' => Storage::url('images/services/pc2.jpeg'), 'title' => 'Skilled & Compassionate', 'description' => 'Combining medical expertise with a gentle, understanding approach.'],
            ['url' => Storage::url('images/services/pc3.jpeg'), 'title' => 'A Peaceful Journey', 'description' => 'Creating a calm and serene environment for our patients and their families.'],
            ['url' => Storage::url('images/services/pc4.jpeg'), 'title' => 'Skilled & Compassionate', 'description' => 'Combining medical expertise with a gentle, understanding approach.'],
        ...
        $highlightCards = [
            ...
            [
                'icon' => Storage::url('images/icons/quality.png'),
                'alt' => 'Quality of Life',
                'title' => 'Quality of Life',
                'description' => 'Focusing on comfort and well-being.',
            ],
            [
                'icon' => Storage::url('images/icons/patient-first.png'),
