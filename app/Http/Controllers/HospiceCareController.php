...
class HospiceCareController extends Controller
{
    ...
    {
        $sliderImages = [
            ['url' => 'images/services/hospice-1.jpg', 'title' => 'Comfort and Dignity', 'description' => 'Providing compassionate care that focuses on quality of life.'],
            ['url' => 'images/services/hospice-2.jpg', 'title' => 'Symptom Management', 'description' => 'Expert medical care to manage pain and other symptoms.'],
            ['url' => 'images/services/hospice-3.jpg', 'title' => 'Emotional and Spiritual Support', 'description' => 'Caring for the whole person, not just the illness.'],
        ];
